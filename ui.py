...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setWindowIcon(QtGui.QIcon('media/logo.png'))
        ...
        self.Button_Start.setGeometry(QtCore.QRect(150, 120, 111, 31))  # 修改：y坐标从160改为120
        font = QtGui.QFont()
        font.setFamily("黑体")
        font.setPointSize(10)
        ...
        self.Button_End.setGeometry(QtCore.QRect(150, 160, 111, 31))  # 修改：y坐标从120改为160
        font = QtGui.QFont()
        font.setFamily("黑体")
        font.setPointSize(10)
        ...
        self.output_Window.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(255, 255, 255, 255), stop:1 rgba(240, 240, 240, 255));")
        self.output_Window.setObjectName("output_Window")

        # ------------------- 右侧视频显示区 -------------------
        self.graphicsView = QtWidgets.QGraphicsView(self.centralwidget)
        self.graphicsView.setGeometry(QtCore.QRect(300, 50, 730, 550))
        self.graphicsView.setStyleSheet("background-color: white; border: 1px solid #cccccc;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Dlib疲劳检测警报系统 - Create By BHML 2025."))
        self.label.setText(_translate("MainWindow", "功能设置"))
        self.label_2.setText(_translate("MainWindow", "视频设置"))
        self.Cam_Select.addItem(_translate("MainWindow", "摄像头1"))
        self.Cam_Select.addItem(_translate("MainWindow", "摄像头2"))
        self.Cam_Select.addItem(_translate("MainWindow", "摄像头3"))
        ...
        self.show_eye.setText(_translate("MainWindow", "眼部"))
        self.show_mouth.setText(_translate("MainWindow", "嘴部"))
